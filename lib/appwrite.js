...
export const deleteVideo = async (videoId) => {
    try {
        ...
        // Check the Creator of the current video is the current User
        console.log(currentVideo.creator.$id);
        console.log(currentUser.$id)
        if (currentVideo.creator.$id === currentUser.$id)
        {
          const result =  await databases.deleteDocument(databaseId, videoCollectionId, videoId);
          console.log(result);
          return result
        }
        else throw new Error('Unauthorized Delete');
